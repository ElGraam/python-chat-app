...
class ClientController:
    ...
    def client_udp_send_handler(self):
        ...
        self.client_model.udp.initial_message(client.chat_room_name, client.token)
        self.client_model.udp.send_message(client.chat_room_name, client.token)
    ...
    def start(self):
        ...
        send_message_thread = threading.Thread(target=self.client_udp_send_handler)
